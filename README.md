...
## 使用方法  
   ...
   * 将以下内容添加到对应框框内
     * 自定义头部  
        ```html
        <link href="https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/alist.css" rel="stylesheet" type="text/css">  
        ```  

     * 自定义内容  

        ```html
        <script src="https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/jq.js"></script>
        ...
        <script src="https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/js/lib.js"></script>
        <script src="https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/js/parallax.min.js"></script>
        <script src="https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/js/app.bundle.js"></script>
        <div id="jsi-flying-fish-container" class="fish-container"></div>
        <script src='https://cdn.jsdmirror.com/gh/Foryings/Better_Alist@main/fish.js'></script>
        ```
